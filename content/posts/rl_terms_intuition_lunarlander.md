...
$$
a_t = \begin{cases} \text{random action}, & \text{with probability } \epsilon, \\ \displaystyle \operatorname*{arg\,max}_{a} Q_{\theta}(s_t,a), & \text{with probability } 1-\epsilon \end{cases}
$$
